...
export function HeroContent() {
  ...
  return (
    <section ref={ref} className="relative w-full h-[78vh] md:h-screen" style={{ background: '#F5F0E8', overflow: 'clip' }}>
      ...
      <motion.div
        style={{ y: logoY, opacity: logoOpacity, position: 'absolute', top: '30%', left: '68%', translateX: '-50%', translateY: '-50%' }}
      ...
      <motion.div
        style={{ x: cardX, opacity: cardOpacity, position: 'absolute', right: '5rem', top: '45%' } as any}
